      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-12">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() => signOut()}
              className="w-full sm:w-auto px-4 py-2 bg-destructive hover:bg-destructive/90 text-destructive-foreground rounded-md transition-colors text-sm sm:text-base flex items-center justify-center gap-2"
            >
